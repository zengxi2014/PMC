...
public class MemoryInfoService {
    ...
    public JSONObject getMemoryAverageRatio(String appId) throws Exception {
        DBCollection cpuInfoCollection = CommonDBManager.MongoDBConnect("MemoryInfo");
    ...
    @Test
    public void testMemoryAverageRato() throws Exception {
        getMemoryAverageRatio("85d4a553-ee8d-4136-80ab-2469adcae44d-abcdefg");
    }
}
