...
public class MFTPM {
	 ...
	 * 初始化函数
	 */
	public static void init(String appId, String minSup) {
/*		List<List<String>> transRecords = fstree
		...
		transRecords = activityRouteInfoBasicService.getRoutes(appId);
		fstree = new MFSTree();
		float Sup=0.0f;
	 ...
	 * @return
	 */
    public static JSONArray getMFSResults(String appId, String minSup){
...
//			freqSequences.add(freqSeq);
			freqSequences.put(freqSeq);
		}
		System.out.println(freqSequences);
		return freqSequences;
	}

	@Test
	public void testGetMFSResults(){
		getMFSResults("85d4a553-ee8d-4136-80ab-2469adcae44d","50");
	}
}
